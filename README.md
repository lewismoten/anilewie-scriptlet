...
Jump ahead 26 years and I'm browsing a few of the old files I still have in my archives. I had fond memeries of my experiments, and decided to bring this little script back to life. This did not make use of any communications such as events and properties talking between the container and the scriptlet iself, so it can run within an iframe as a simple HTML file.
